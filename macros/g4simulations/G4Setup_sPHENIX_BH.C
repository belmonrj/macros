...
int fast_sim_flag = 2; // default is HcalIn for hadrons, other options possible (see below)

void G4FastSimFlag(int flag)
{
  cout << "setting fast sim flag to " << flag;
  fast_sim_flag = flag;
  cout << " " << fast_sim_flag << endl;
}
